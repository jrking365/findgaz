...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.6/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Sep 2016 23:57:59 GMT -->
<head>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="<?php echo base_url(); ?>style/img/profile_small.jpg" />
                             </span>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?php echo base_url(); ?>style/img/a7.jpg">
                                </a>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?php echo base_url(); ?>style/img/a4.jpg">
                                </a>
                                <div class="media-body ">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?php echo base_url(); ?>style/img/profile.jpg">
                                </a>
                                <div class="media-body ">
