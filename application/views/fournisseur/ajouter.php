    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Ajouter un administrateur &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/admin" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Profession</label>
                        <div class="col-lg-10"><input name="profession" type="text" value="<?php echo set_value('profession'); ?>" placeholder="Numéro de télèphone " class="form-control">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <a href="<?php echo base_url(); ?>administration/admin" class="btn btn-danger btn-sm">Annuler</a>
                        </div>
