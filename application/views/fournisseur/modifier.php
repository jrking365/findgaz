    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Modifier un administrateur &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/admin" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Mot de passe  </label>
                        <div class="col-lg-10"><input name="motpasse" type="password" value="<?php echo set_value('motpasse', $motpasse); ?>" placeholder="" class="form-control">
