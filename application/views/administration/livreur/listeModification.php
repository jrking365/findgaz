...
<div class="ibox-title">
    <h5>Liste des demandes de modifications &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/livreur" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                        ...
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="m-t text-righ">
                                    <a href="<?php echo base_url(); ?>administration/livreur/validermodification?oui=<?php echo $nouveau['nouveau'][$i]->id ?>" class="btn btn-xs btn-outline btn-primary">Confimer la modification</a>
                                    <a href="<?php echo base_url(); ?>administration/livreur/validermodification?non=<?php echo $nouveau['nouveau'][$i]->id ?>" class="btn btn-xs btn-outline btn-danger">Refuser la modification</a>
                                </div>
                            </div>
                        </div>
                    </div>
