    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Ajouter un livreur &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/livreur" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Numéro CNI</label>
                        <div class="col-lg-10"><input name="numerocni" type="text" value="<?php echo set_value('numerocni'); ?>" placeholder="Numéro de CNI " class="form-control">
