    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Attribution d'une zone d'action &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/livreur" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Point de vente</label>
                        <div class="col-lg-10"><select name="pointvente" class="form-control">
                        <?php
                        foreach ($pointvente as $row) {
                            echo '<option value="' . $row->nom . '">' . $row->nom . '</option>';
                        }
                        ?>
                        </select> <span class="alert-danger help-block m-b-none"><?php echo form_error('pointvente'); ?></span></div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <a href="<?php echo base_url(); ?>administration/livreur" class="btn btn-danger btn-sm">Annuler</a>
                        </div>
