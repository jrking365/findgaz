    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Supprimer un administrateur &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/admin" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                             <a href="<?php echo base_url(); ?>administration/admin/valider_suppression?id=<?php echo $utilisateur->id ?>" class="btn btn-warning btn-sm">Supprimer</a>
