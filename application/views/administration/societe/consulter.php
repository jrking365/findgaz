    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>La société &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/societes" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        <div>
                            <a href="<?php echo base_url(); ?>administration/societes" class="btn btn-warning btn-sm">Retour</a>
                        </div>
                    </div>
