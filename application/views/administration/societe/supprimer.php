    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Supprimer une société &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/societes" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                             <a href="<?php echo base_url(); ?>administration/societes/valider_suppression?id=<?php echo $societe->id ?>" class="btn btn-warning btn-sm">Supprimer</a>
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Nom</label>
                        <div class="col-lg-10"><input disabled readonly name="nom" value="<?php echo set_value('nom',$nom); ?>" type="text" placeholder="Nom" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Libellé</label>
                        <div class="col-lg-10"><input disabled readonly name="libelle" value="<?php echo set_value('libelle', $libelle); ?>" type="text" placeholder="Libellé" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Logo</label>
                        <div class="col-lg-10"><input disabled readonly name="logo" type="text" value="<?php echo set_value('logo', $logo); ?>" placeholder="Logo" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Slogan</label>
                        <div class="col-lg-10"><input disabled readonly name="slogan" type="text" value="<?php echo set_value('slogan', $slogan); ?>" placeholder="Slogan" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Site web </label>
                        <div class="col-lg-10"><input disabled readonly name="siteweb" type="text" value="<?php echo set_value('siteweb', $siteweb); ?>" placeholder="Site web" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Contact</label>
                        <div class="col-lg-10"><input disabled readonly name="contact" type="text" value="<?php echo set_value('contact', $contact); ?>" placeholder="Contact" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Boite postal</label>
                        <div class="col-lg-10"><input disabled readonly name="boitepostal" type="text" value="<?php echo set_value('boitepostal', $boitepostal); ?>" placeholder="Boite postal" class="form-control">
