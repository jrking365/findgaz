    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Modifier un visiteur &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/visiteurs" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><input name="adressemac" value="<?php echo set_value('adressemac', $adressemac); ?>" type="text" placeholder="Adresse MAC" class="form-control">
