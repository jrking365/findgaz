    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Supprimer un gaz &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/gaz/liste" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                             <a href="<?php echo base_url(); ?>administration/gazs/valider_suppression?id=<?php echo $gaz->id ?>" class="btn btn-warning btn-sm">Supprimer</a>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><select disabled name="produit"  class="form-control m-b">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><select disabled name="formatproduit"  class="form-control m-b">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Prix unitaire</label>
                        <div class="col-lg-10"><input disabled readonly="" name="prix_unitaire" value="<?php echo set_value('prix_unitaire', $prix_unitaire); ?>" type="text" placeholder="Prix unitaire" class="form-control">
