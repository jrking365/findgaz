    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Modifier la région &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/lister" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
