    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Supprimer la région &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/lister" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <a href="<?php echo base_url(); ?>administration/circonscription/valid_sup_region?id=<?php echo $region->id; ?>" class="btn btn-danger btn-sm">supprimer</a>
                            <a href="<?php echo base_url(); ?>administration/circonscription/lister" class="btn btn-warning btn-sm">Annuler</a>
                        </div>
