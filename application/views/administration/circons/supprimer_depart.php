...
$id_region = $departement->region;
$libelle_region = $departement->getRegion->libelle;
?>
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Modifer un département  &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/listede" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Région </label>
                        <div class="col-lg-10"><select disabled name="region"  class="form-control m-b">
                                <option value="<?php echo set_value('region', $id_region); ?>"><?php echo set_value('region', $libelle_region); ?></option>
                                <?php
                            ...
                            <span class="alert-danger help-block m-b-none"><?php echo form_error('region'); ?></span></div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <a href="<?php echo base_url(); ?>administration/circonscription/valid_sup_depart?id=<?php echo $departement->id; ?>" class="btn btn-danger btn-sm">Supprimer</a>
                            <a href="<?php echo base_url(); ?>administration/circonscription/listede" class="btn btn-warning btn-sm">Annuler</a>
                        </div>
