    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Ajouter un département  &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/listede" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Région </label>
                        <div class="col-lg-10"><select name="region"  class="form-control m-b">
                                <option><?php echo set_value('region'); ?></option>
                                <?php
