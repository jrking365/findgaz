...
<?php 
    ...
    $id_commune = $commune->departement;
    $libelle_commune = $commune->getDepartement->libelle;
?>
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Modifer un Commnune  &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/listecomm" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Département </label>
                        <div class="col-lg-10"><select name="departement"  class="form-control m-b">
                                <option value="<?php echo set_value('departement', $id_commune); ?>"><?php echo set_value('departement',$libelle_commune); ?></option>
                                <?php
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <a href="<?php echo base_url(); ?>administration/circonscription/listecomm" class="btn btn-danger btn-sm">Annuler</a>
                        </div>
