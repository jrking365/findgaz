    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Modifer un quartier  &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>dministration/circonscription/liste_quartier" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Description</label>
                        <div class="col-lg-10"><input name="description" value="<?php echo set_value('description', $description); ?>" type="text" placeholder="Description " class="form-control">
