    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Supprimer une historique de navigation &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/historiquenavigation/liste" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                             <a href="<?php echo base_url(); ?>administration/historiquenavigations/valider_suppression?id=<?php echo $historiquenavigation->id ?>" class="btn btn-warning btn-sm">Supprimer</a>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><select disabled name="utilisateur"  class="form-control m-b">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10"><select disabled name="page"  class="form-control m-b">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Date de navigation</label>
                        <div class="col-lg-10"><input disabled readonly="" name="datenavigation" value="<?php echo set_value('datenavigation', $datenavigation); ?>" type="text" placeholder="Prix unitaire" class="form-control">
