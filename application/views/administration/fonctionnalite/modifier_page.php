    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5> Modifier une page &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/fonctionnalite/liste_page" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
