    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Details du personnel &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/personnel" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
                ...
                <form class="form-horizontal" method="" action="">
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <a href="<?php echo base_url(); ?>administration/personnel/supprimer?id=<?php echo $utilisateur->id ?>" class="btn btn-sm btn-warning" >Supprimer</a>
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Genre</label>
                        <div class="col-lg-10"><select disabled="" name="genre"  class="form-control m-b">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Statut matrimonial</label>
                        <div class="col-lg-10"><select disabled="" name="statutmatrimonial"  class="form-control m-b">
