    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox-title">
                <h5>Ajouter un format de produit &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo base_url(); ?>administration/formatproduits" class="btn btn-default btn-sm"><span class="fa fa-mail-reply"></span></a> </h5>
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Masse</label>
                        <div class="col-lg-10"><input name="masse" value="<?php echo set_value('masse'); ?>" type="text" placeholder="Masse" class="form-control">
                    ...
                    <div class="form-group"><label class="col-lg-2 control-label">Unité</label>
                        <div class="col-lg-10"><input name="unite" value="<?php echo set_value('unite'); ?>" type="text" placeholder="Unité" class="form-control">
