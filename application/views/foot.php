<div class="footer">
    ...
    <script src="<?php echo base_url(); ?>style/js/jquery-ui-1.10.4.min.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="<?php echo base_url(); ?>style/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?php echo base_url(); ?>style/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.6/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Sep 2016 23:58:12 GMT -->
</html>
